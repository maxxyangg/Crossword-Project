...
public class APIConnector {
	...
	//http://localhost/indic-wp/api/getLogicalChars.php?string="+string+"&language=English
	//"https://indic-wp.thisisjava.com/api/getLogicalChars.php?string=" + string + "&language=English"
	public void getLogicalChars() {
		try {
			String string = stringInput.replace(" ", "%20");
			string = string.replace("’", "'");
			logicalCharsURL = new URL("https://indic-wp.thisisjava.com/api/getLogicalChars.php?string=" + string + "&language=English");
